...
describe('Hiddify Clash compatibility', () => {
    it('does not emit remote rule-providers for automatic Hiddify requests', () => {
        const node =
            'vless://8b540f5c-62c1-4492-83f6-944f534ad026@cf.example.com:443?security=tls&sni=edge.example.com&type=ws&host=edge.example.com&path=%2F&encryption=none#Hiddify-Test';
