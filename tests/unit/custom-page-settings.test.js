...
vi.mock('../../src/components/ui/Switch.vue', () => ({
    default: {
        ...
        template:
            '<button class="switch-stub" type="button" @click="$emit(\'update:modelValue\', !modelValue)">{{ String(modelValue) }}</button>',
    },
}));
...
const mountSettings = (settings = {}) =>
    mount(CustomPageSettings, {
        props: {
