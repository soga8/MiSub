...
describe('Egern native renderer', () => {
    ...
    it('maps anytls using Egern proxy schema', () => {
        const rendered = transformBuiltinSubscription(
            'anytls://9d6c62f6-e38d-4146-ab3e-d40568555f89@156.239.232.67:443/?sni=xkhkfree.99887766.best&allowInsecure=1#AnyTLS-HK',
            'egern'
        );
        const parsed = yaml.load(rendered);
