<script setup>
    ...
    const sanitizedContent = computed(() =>
        DOMPurify.sanitize(announcement.value.content || '', {
    ...
    <div class="space-y-6">
        ...
        >
            ...
            >
                ...
                <Switch v-model="announcement.enabled" @change="handleContentUpdate" />
            </div>
        </div>
        ...
        >
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label
                        ...
                        >{{ t('settings.announcementFieldTitle') }}</label
                    >
                    <input
                        type="text"
                ...
                <div>
                    <label
                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
                        >{{ t('settings.announcementType') }}</label
                    >
                    <select
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{
                    t('settings.announcementContent')
                }}</label>
                <div class="relative">
                    <textarea
            ...
            >
                ...
                <div
                    class="bg-white dark:bg-gray-800 misub-radius-md shadow-sm border p-4"
                    :class="{
                ...
                >
                    <div class="flex items-start gap-3">
                        <div class="flex-shrink-0 mt-0.5">
                            <span v-if="announcement.type === 'info'" class="text-blue-500"
                                >ℹ️</span
                            >
                            <span v-if="announcement.type === 'success'" class="text-green-500"
                                >✅</span
                            >
                            <span v-if="announcement.type === 'warning'" class="text-yellow-500"
                                >⚠️</span
                            >
                            <span v-if="announcement.type === 'error'" class="text-red-500"
                                >⛔</span
                            >
                        </div>
                        <div class="flex-1">
                            ...
                            <div
                                class="text-sm text-gray-600 dark:text-gray-300 mt-1 prose prose-sm dark:prose-invert max-w-none"
