...
<template>
    <div ref="listRef" class="drag-drop-list" :style="listStyle">
        <!-- 列表容器 -->
        <div class="drag-drop-container">
            ...
            <!-- 列表项目 -->
            <div v-else class="drag-drop-items" :class="{ 'is-dragging': dragState.isDragging }">
                <div
                                    ...
                                    <div>
                                        ...
                                        >
                                            {{
                                                item.name ||
                                                item.title ||
                                                t('common.itemName', { index: index + 1 })
                                            }}
                                        </h4>
                                        <p
