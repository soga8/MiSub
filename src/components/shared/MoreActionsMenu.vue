<script setup>
    ...
    const FOCUSABLE = ['button:not([disabled])', 'a[href]', '[tabindex]:not([tabindex="-1"])'].join(
        ', '
    );
    ...
    const fixedMenuPosition = computed(() => {
        ...
        const isInsideModal = Boolean(
            triggerRef.value.closest('[role="dialog"][aria-modal="true"]')
        );
        return {
...
<template>
    <div ref="triggerRef" class="relative shrink-0">
        <button
            ...
            class="p-2.5 misub-radius-md hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
        >
            <svg
        ...
        <Transition name="slide-fade-sm">
            <div
                ...
                :class="[
                    'absolute right-0 mt-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm misub-radius-lg shadow-lg dark:shadow-2xl z-50 ring-1 ring-black/5',
                    menuWidthClass,
                ]"
            >
        ...
        <Teleport v-if="teleportToBody" to="body">
            <Transition name="slide-fade-sm">
                <div
                    ...
                    role="menu"
                    :class="[
                        'fixed mt-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm misub-radius-lg shadow-lg dark:shadow-2xl ring-1 ring-black/5',
                        menuWidthClass,
                    ]"
