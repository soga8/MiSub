    ...
    <div class="relative w-full">
        ...
        >
            <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                ...
                <div
                    class="flex-shrink-0 flex flex-col items-center lg:items-start text-center lg:text-left space-y-4"
                >
                    <div
                    ...
                    <div class="flex items-center gap-4">
                        <div
                            class="h-16 w-16 misub-radius-lg bg-gradient-to-br from-primary-500 to-purple-600 flex items-center justify-center shadow-lg shadow-primary-500/20 text-3xl"
                        >
                            🚀
                        </div>
                        <div>
                ...
                <div
                    class="flex-1 border-t lg:border-t-0 lg:border-l border-gray-100 dark:border-white/5 pt-6 lg:pt-0 lg:pl-12 w-full lg:w-auto text-center lg:text-left"
                >
                    <p
