...
<template>
    <div
        class="hidden lg:flex flex-1 overflow-hidden rounded-xl border border-gray-200/70 bg-white shadow-sm dark:border-white/10 dark:bg-white/5"
    >
        <div ref="containerRef" class="h-full overflow-y-auto w-full">
            <div class="w-full px-4 py-3">
                <div
                    class="w-full overflow-hidden rounded-xl border border-gray-200/70 dark:border-white/10"
                >
                    <!-- 表头 -->
                    <div
                    ...
                    >
                        ...
                        >
                            <div
                                v-if="selectionMode"
                                class="col-span-1 flex justify-center text-indigo-500"
                            >
                                Pick
                            </div>
                    ...
                    >
                        <div :style="{ transform: `translateY(${offsetY}px)` }">
                            ...
                            >
                                <div
                                    class="grid min-h-[3.5rem] grid-cols-12 gap-2 px-6 py-3 items-center"
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <svg
                                                v-if="selectedUrls.has(node.url)"
                                    ...
                                    <div :class="selectionMode ? 'col-span-3' : 'col-span-4'">
                                        <span
                                            class="text-sm font-bold text-gray-900 dark:text-white block overflow-hidden group-hover:text-indigo-600 transition-colors"
                                            :title="parseNodeInfo(node).name"
                                    ...
                                    <div class="col-span-3 hidden sm:block">
                                        <span
                                            class="text-[11px] text-gray-500 dark:text-gray-400 font-mono block overflow-hidden opacity-70 group-hover:opacity-100 transition-opacity"
                                            :title="parseNodeInfo(node).server"
                                            style="text-overflow: ellipsis; white-space: nowrap"
                                        >
                                    ...
                                    <div class="col-span-2 hidden md:block text-center">
                                        <span
                                            class="text-xs font-bold text-gray-500 dark:text-gray-400 font-mono block opacity-70"
                                    ...
                                    <div class="col-span-1 hidden sm:block flex justify-center">
                                        <span
                                            class="inline-flex items-center justify-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-gray-100 text-gray-600 dark:bg-white/5 dark:text-gray-400"
